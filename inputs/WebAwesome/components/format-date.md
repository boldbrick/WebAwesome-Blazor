<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/format-date.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/format-date -->
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.11.0/components/format-date/format-date.js';
```
