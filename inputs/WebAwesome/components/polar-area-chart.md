<!-- Source: https://webawesome.com/docs/components/polar-area-chart (fetched 2026-07-23 for Web Awesome 3.3.0; public web docs — component absent from the public GitHub docs tree) -->
