<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/input.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/input -->
...
| \`input-wrapper\` | The component's outer wrapper. | \`::part(input-wrapper)\` |
...
| \`base\` | \`input-wrapper\` Deprecated. Use the part instead. | \`::part(base)\` |
