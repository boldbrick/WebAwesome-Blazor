<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/drawer.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/drawer -->
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.11.0/components/drawer/drawer.js';
```
...
| \`lightDismiss\` light-dismiss | \`boolean\` When enabled, the drawer will be closed when the user clicks outside of it. Type Default false | |
...
| --- | --- |
| \`end\` default | The end (right, in LTR) |
