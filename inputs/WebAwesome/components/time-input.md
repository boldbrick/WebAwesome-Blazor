<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/time-input.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/time-input -->
...
| Sub-minute steps | \`HH:mm:ss\` | \`step\` When < 60 and the seconds segment shows; e.g. 14:30:15 |
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.11.0/components/time-input/time-input.js';
```
...
| \`base\` | \`time-input\` Deprecated. Use the part instead. | \`::part(base)\` |
