<!-- Source: https://webawesome.com/docs/components/page (Web Awesome 3.1.0 Pro component, not in public GitHub docs) -->
<!--
Pro component — not documented in the public GitHub repo; ingested from the public web docs.
The public web docs are served only at the current live version (3.10.0 at fetch time on
2026-07-22), so the "Importing" CDN version token and any API added after 3.1 reflect 3.10.0.
The wrapper follows the target 3.1.0 Custom Elements Manifest.
-->
...
Stable [Layout](/docs/components/?category=layout) [Since 3.0](/docs/resources/changelog#wa_300)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.10.0/components/page/page.js';
```
...
The footer for a navigation area. On mobile this will be the footer for [`<wa-drawer>`](/docs/components/drawer).

`navigation-header`

The header for a navigation area. On mobile this will be the header for [`<wa-drawer>`](/docs/components/drawer).

`navigation-toggle`

Use this slot to slot in your own button + icon for toggling the navigation drawer. By default it is a [`<wa-button>`](/docs/components/button) + a 3 bars [`<wa-icon>`](/docs/components/icon)

`navigation-toggle-icon`

Use this to slot in your own icon for toggling the navigation drawer. By default it is 3 bars [`<wa-icon>`](/docs/components/icon).
...
The [`<wa-drawer>`](/docs/components/drawer) that contains the navigation on mobile viewports.
...
The wrapper around the main header, content, and footer.
...
The `<nav>` for navigation on desktop viewports.
...
The default [`<wa-button>`](/docs/components/button) that will toggle the [`<wa-drawer>`](/docs/components/drawer) for mobile viewports.

`::part(navigation-toggle)`

`navigation-toggle-icon`

The default [`<wa-icon>`](/docs/components/icon) displayed inside of the navigation-toggle button.
...
Deprecated. Use the `page` part instead.
