<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/tree-item.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/tree-item -->
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.11.0/components/tree-item/tree-item.js';
```
...
| \`tree-item\` | The component's outer wrapper. | \`::part(tree-item)\` |
| \`base\` | \`tree-item\` Deprecated. Use the part instead. | \`::part(base)\` |
