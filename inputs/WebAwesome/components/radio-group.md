<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/radio-group.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/radio-group -->
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.11.0/components/radio-group/radio-group.js';
```
