<!-- Source: reference doc bundled in the Web Awesome 3.11.0 release zip (dist/skills/webawesome/references/components/checkbox.md) -- component absent from the public GitHub docs tree. Full documentation: https://webawesome.com/docs/components/checkbox -->
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.11.0/components/checkbox/checkbox.js';
```
...
| \`base\` | \`checkbox\` Deprecated. Use the part instead. | \`::part(base)\` |
