...
/// <summary>
/// EditForm integration tests for WaSelect in single-selection mode: two-way binding of its nullable
...
/// </summary>
public class WaSelectEditFormTests : FormControlTestBase
{
    [Fact]
    public void RendersBoundValueAndValidClass()
    {
        var model = new SelectModel { Fruit = "apple" };
    ...
    public void UserChange_UpdatesModelThroughBinding()
    {
        ...
        cut.Find("wa-select").Change("banana");
    ...
    public void InvalidUserInput_GetsModifiedInvalidCssClasses()
    {
        ...
        cut.Find("wa-select").Change("");

        var cssClass = cut.Find("wa-select").GetAttribute("class");
    ...
    {
        var model = new SelectModel { Fruit = null };
        ...
        Assert.Contains("invalid", cut.Find("wa-select").GetAttribute("class"));
    }
    ...
    public async Task SetCustomValidityAsync_ReachesInteropModule()
    {
        ...
        var model = new SelectModel { Fruit = "apple" };
        var cut = RenderForm(model);
        var component = cut.FindComponent<WaSelect>().Instance;
    ...
    private IRenderedComponent<EditForm> RenderForm(SelectModel model, Action<EditContext>? onEditContext = null)
    {
        return RenderControlForm<WaSelect, string?>(
            model,
            model.Fruit,
