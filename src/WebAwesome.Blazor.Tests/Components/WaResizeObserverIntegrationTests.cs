...
/// <summary>
/// Integration tests for WaResizeObserver component focusing on validation
/// </summary>
public class WaResizeObserverIntegrationTests
{
    [Fact]
    public async Task DisconnectAsync_WithNullElement_ThrowsInvalidOperationException()
    {
        // Arrange
        var component = new WaResizeObserver();
